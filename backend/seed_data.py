...
SEED_PRODUCTS = [
    ...
    },
    {
        ...
        "image": "https://images.pexels.com/photos/7717461/pexels-photo-7717461.jpeg?auto=compress&cs=tinysrgb&w=1200", "featured": False, "order": 5,
    },
    {
    ...
    },
    {
        ...
        "image": IMG["african_agri"], "featured": False, "order": 9,
    },
    {
    ...
    },
    {
        ...
        "image": IMG["sustain"], "featured": False, "order": 13,
    },
    {
        ...
        "image": IMG["african_agri"], "featured": False, "order": 17,
    },
    {
        ...
        "image": IMG["warehouse"], "featured": False, "order": 21,
    },
    {
        ...
        "image": IMG["african_agri"], "featured": True, "order": 22,
    },
    {
        "name": "Compost organique enrichi", "category": "fertilisants", "subcategory": None,
        "description": "Amendement organique riche en matière humique pour améliorer durablement la structure et la vie microbienne des sols.",
        "characteristics": ["Riche en matière organique", "Améliore la rétention d'eau", "Sacs de 40 kg"],
        "applications": ["Maraîchage", "Cultures fruitières", "Régénération des sols"],
        "image": IMG["sustain"], "featured": False, "order": 7,
    },
    {
        "name": "Engrais foliaire soluble", "category": "fertilisants", "subcategory": None,
        "description": "Fertilisant foliaire à absorption rapide pour corriger les carences en cours de culture et stimuler la croissance.",
        "characteristics": ["100% hydrosoluble", "Riche en oligo-éléments", "Application par pulvérisation"],
        "applications": ["Maraîchage", "Cultures de rente", "Correction de carences"],
        "image": "https://images.pexels.com/photos/31673795/pexels-photo-31673795.jpeg?auto=compress&cs=tinysrgb&w=1200", "featured": False, "order": 8,
    },
    {
        "name": "Herbicide de prélevée", "category": "herbicides", "subcategory": None,
        "description": "Solution de désherbage appliquée avant la levée des adventices, pour un contrôle durable des mauvaises herbes.",
        "characteristics": ["Action de prélevée", "Homologué CSP", "Bidon de 1 L et 5 L"],
        "applications": ["Riziculture", "Cultures industrielles", "Préparation des parcelles"],
        "image": IMG["african_agri"], "featured": False, "order": 11,
    },
    {
        "name": "Désherbant sélectif riz", "category": "herbicides", "subcategory": None,
        "description": "Herbicide sélectif spécialement formulé pour la riziculture, respectueux de la culture du riz.",
        "characteristics": ["Sélectif riz", "Action post-levée", "Conforme aux normes"],
        "applications": ["Riziculture irriguée", "Riziculture pluviale"],
        "image": "https://images.pexels.com/photos/37965300/pexels-photo-37965300.jpeg?auto=compress&cs=tinysrgb&w=1200", "featured": False, "order": 12,
    },
    {
        "name": "Insecticide systémique", "category": "insecticides", "subcategory": None,
        "description": "Insecticide à action systémique offrant une protection prolongée contre les ravageurs des cultures.",
        "characteristics": ["Action systémique", "Longue rémanence", "Homologué"],
        "applications": ["Cacaoyer", "Cultures maraîchères", "Vergers"],
        "image": "https://images.pexels.com/photos/37965300/pexels-photo-37965300.jpeg?auto=compress&cs=tinysrgb&w=1200", "featured": False, "order": 14,
    },
    {
        "name": "Insecticide de contact", "category": "insecticides", "subcategory": None,
        "description": "Insecticide à action de contact rapide pour maîtriser efficacement les infestations d'insectes.",
        "characteristics": ["Action rapide de contact", "Large spectre", "Bidon de 1 L"],
        "applications": ["Cultures vivrières", "Maraîchage"],
        "image": IMG["african_agri"], "featured": False, "order": 15,
    },
    {
        "name": "Insecticide biologique (bio-contrôle)", "category": "insecticides", "subcategory": None,
        "description": "Solution de bio-contrôle respectueuse de l'environnement pour une protection raisonnée des cultures.",
        "characteristics": ["Origine biologique", "Respectueux des auxiliaires", "Adapté à l'agriculture durable"],
        "applications": ["Maraîchage biologique", "Cultures sensibles"],
        "image": IMG["sustain"], "featured": False, "order": 16,
    },
    {
        "name": "Fongicide de contact", "category": "fongicides", "subcategory": None,
        "description": "Traitement préventif de contact contre les principales maladies fongiques des cultures.",
        "characteristics": ["Action préventive", "Bonne adhérence foliaire", "Sachet hydrosoluble"],
        "applications": ["Maraîchage", "Bananeraie", "Vergers"],
        "image": "https://images.pexels.com/photos/37965300/pexels-photo-37965300.jpeg?auto=compress&cs=tinysrgb&w=1200", "featured": False, "order": 18,
    },
    {
        "name": "Fongicide cuprique", "category": "fongicides", "subcategory": None,
        "description": "Fongicide à base de cuivre, référence pour la lutte contre les maladies cryptogamiques.",
        "characteristics": ["À base de cuivre", "Préventif", "Homologué"],
        "applications": ["Cacaoyer", "Cultures maraîchères"],
        "image": IMG["african_agri"], "featured": False, "order": 19,
    },
    {
        "name": "Traitement fongicide de semences", "category": "fongicides", "subcategory": None,
        "description": "Protection des semences contre les champignons telluriques dès le semis pour une levée saine.",
        "characteristics": ["Traitement de semences", "Protège la germination", "Faible dose d'emploi"],
        "applications": ["Céréales", "Légumineuses", "Cultures industrielles"],
        "image": IMG["sustain"], "featured": False, "order": 20,
    },
    {
        "name": "Semoir manuel de précision", "category": "equipements", "subcategory": None,
        "description": "Semoir manuel robuste permettant un semis régulier et précis, idéal pour les petites et moyennes exploitations.",
        "characteristics": ["Réglage de densité de semis", "Ergonomique", "Faible entretien"],
        "applications": ["Maraîchage", "Cultures vivrières"],
        "image": IMG["warehouse"], "featured": False, "order": 23,
    },
    {
        "name": "Motopompe agricole thermique", "category": "equipements", "subcategory": None,
        "description": "Motopompe thermique puissante pour l'irrigation et le transfert d'eau sur les exploitations agricoles.",
        "characteristics": ["Moteur thermique", "Fort débit", "Aspiration/refoulement"],
        "applications": ["Irrigation", "Transfert d'eau", "Maraîchage"],
        "image": "https://images.pexels.com/photos/11996941/pexels-photo-11996941.jpeg?auto=compress&cs=tinysrgb&w=1200", "featured": False, "order": 24,
    },
]
