...
import {
  ...
  Handshake, Mail, FileText, Send, LogOut, ExternalLink, Menu, X, Images, Share2, Layers,
} from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/medias", label: "Médiathèque", icon: Images },
  { to: "/admin/reseaux", label: "Réseaux sociaux", icon: Share2 },
