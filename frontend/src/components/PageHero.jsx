  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#08160c]/92 via-[#0b1f10]/80 to-[#0E7A3A]/40" />
      </div>
      <div className="container-stmp relative z-10 py-20 md:py-28">
        ...
        >
          <nav className="flex items-center gap-1.5 text-sm text-white/70 mb-4">
            ...
            <span className="text-[#F2D400]">{crumb}</span>
          </nav>
          <h1 className="font-heading text-4xl md:text-5xl font-bold tracking-tight text-white max-w-3xl">
            {title}
          </h1>
